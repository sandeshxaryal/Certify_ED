// src/handlers/credential.handler.js
/* 
...
*/
import logActivity from '../helpers/recordLog.js';
import fs from 'fs';
import path from 'path';
import crypto from 'crypto';
import axios from 'axios';
import { generateCertificatePdf } from '../helpers/documentHelpers.js';
import * as pinata from '../helpers/ipfsClient.js';
import { web3, contract, getWeb3, getContract } from '../helpers/chainService.js';
import { PINATA_GATEWAY_BASE_URL } from '../config.js';
import Certificate from '../schemas/credential.schema.js';
import { CID } from 'multiformats/cid'
import * as Block from 'multiformats/block'
import { sha256 } from 'multiformats/hashes/sha2'
import { pdfUpload } from '../guards/upload.guard.js';
import multer from 'multer';
import { computePDFHash, getStoredHashFromBlockchain } from '../helpers/documentHashHelpers.js';
import {
  isValidCID,
  computePDFHashes,
...
} from '../helpers/credentialHelpers.js';
import {
  successResponse,
...
import { uploadBufferToPinata } from '../helpers/ipfsClient.js';
import { sendCertificateEmail } from '../helpers/mailerHelpers.js';
import { estimateCost } from '../helpers/etherHelpers.js'
